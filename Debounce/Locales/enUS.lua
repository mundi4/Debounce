...
L["SELECTED_TARGET_UNIT"] = "Assigned Target |cnBLUE_FONT_COLOR:(%s)|r"
...
L["TYPE_UNUSED_DESC"] = "Use this action to disable the binding for a specific key in a certain situation."
